  ...
  return (
    <div className="about">
      ...
      <div className="about-right">
        ...
        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Molestias, magnam facilis? Pariatur necessitatibus, eos nisi impedit minima distinctio architecto laborum quo incidunt animi. Ratione quibusdam dicta, repudiandae eos delectus explicabo nesciunt incidunt nulla quo aspernatur.</p>
      </div>
    </div>
  );
};
